...
// import { CATALOG_ITEMS, type CatalogItem } from "../../src/data/catalogData";
...
//           <strong>gift</strong>. We&apos;ll highlight which catalog sections are most
//           relevant.
//         </p>
...
//             }}
//           >
//             No search term entered yet. The list below shows all catalog categories we
//             typically work with.
//           </p>
//         )}
...
export const metadata: Metadata = {
  ...
  description:
    "Search vrikshcrafts for examples of wooden decor for cafés, offices, studios, and decor stores.",
};
      ...
      fallback={
        <section className="hero">
          <div className="container">
            ...
            <h1 className="hero-title">Loading search…</h1>
            <p className="hero-subtitle">
              Please wait while we prepare your search results.
            </p>
          </div>
        </section>
      }
